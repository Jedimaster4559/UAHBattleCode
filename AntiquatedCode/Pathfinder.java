...
class Path 
{
	...
	class cell(MapLocation x, MapLocation y)
	{
		...
		//MapLocation y;
		double totalDist;
		double distFromStart;	// exact value : keeps track of the distance traveled from the start position
		double distFromGoal;	// estimate value : aren't sure what obstacles stand between start and goal
		//bool passable = true;	
	}
